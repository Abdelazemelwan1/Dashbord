                    ...
                    {menuItems.map((item)=>{
                        return (
                            <div key={item.id}>
                                ...
                                className={`w-full flex items-center justify-between p-3 py-2 rounded-xl transition-all duration-200 ${currentPage === item.id || item.active ?
                ...
                {!collapsed && (
                    <div className='p-4 border-t border-slate-200/50 dark:border-slate-700/50'>
                        <div className='flex items-center space-x-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-800/50'>
                            <img src="https://play-lh.googleusercontent.com/vco-LT_M58j9DIAxlS1Cv9uvzbRhB6cYIZJS7ocZksWRqoEPat_QXb6fVFi77lciJZQ=w526-h296-rw" alt="" className='w-10 h-10 rounded-full ring-2 ring-blue-500'/>
